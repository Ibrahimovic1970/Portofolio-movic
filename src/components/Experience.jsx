...
const experiences = [
    { period: '2023 - Sekarang', role: 'IT', company: 'SMK TI BAZMA', location: 'Bogor', desc: 'Siswa di SMK TI BAZMA' }
];
        ...
        <section id="experience" style={{ padding: '120px 0', background: 'var(--bg-secondary)' }}>
            <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '0 24px' }}>
                <div ref={ref} className="reveal-up" style={{ textAlign: 'center', marginBottom: '64px' }}>
                    ...
                    <h2 className="section-title"><span className="gradient-text">Pendidikan</span></h2>
                </div>
                ...
                <div style={{ position: 'relative', paddingLeft: '32px', borderLeft: '2px solid var(--border-color)' }}>
                    {experiences.map((exp, i) => (
                        <div key={i} style={{ position: 'relative', marginBottom: '48px', paddingLeft: '32px' }}>
                            <div style={{ position: 'absolute', left: '-39px', top: '4px', width: '16px', height: '16px', background: 'var(--bg-primary)', border: '3px solid var(--accent-primary)', borderRadius: '50%', zIndex: 1 }} />
                            ...
                            >
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '16px', marginBottom: '12px', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
                                    <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><FiCalendar size={16} /> {exp.period}</span>
                                    <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}><FiMapPin size={16} /> {exp.location}</span>
                                </div>
